    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
           ...
           // logger.LogInfo($"Lines: {lines[0]}");
            ...
            // TODO: Create two `ITrackable` variables with initial values of `null`. //done
            // These will be used to store your two Taco Bells that are the farthest from each other.
            ITrackable initial1 = null;
            ITrackable initial2 = null;
            ...
            for (int i = 0; i < locations.Length; i++)
            {
                ...
                for (int j = i + 1; j < locations.Length; j++)
                {
                    ...
                    // Calculate distance between locA and locB
                    double curDistance = corA.GetDistanceTo(corB);

                    // Update farthest distance and locations if a farther pair is found
            ...
            // Naming suggestion for variable: `locB` //done

            //done // TODO: Once you have locB, create a new Coordinate object called `corB` with your locB's latitude and longitude. //done
            ...
            Console.WriteLine($"{initial1.Name} and {initial2.Name} are the two farthest Taco Bells away from each other.");
